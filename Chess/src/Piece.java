...
public class Piece {
    ...
    public void promotePawn(int row, boolean isBlack) {
        //Checking for pawns color and position to see if it can be promoted
        if (((isBlack && row == 7) || (!isBlack && row == 0)) && (character == '♟' || character == '♙')) {

            Scanner myScanner = new Scanner(System.in);
            System.out.println("Promote your pawn, Q = Queen, R = Rook, B = Bishop, K = Knight");
            String pick = myScanner.nextLine().toUpperCase();
     ...
     */
    public String toString() { return String.valueOf(character);}
